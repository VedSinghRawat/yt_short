...
class AnalyticsService {
  ...
  Future<void> attemptScrollForward({required num level, required num sublevel, required String levelId}) async {
  ...
  Future<void> sublevelLoop({required num level, required num sublevel, required String levelId}) async {
    await _logCustomEvent(
  ...
  Future<void> exerciseRetry({required SpeechExercise speechExercise}) async {
    await _logCustomEvent(
  ...
  Future<void> _logCustomEvent({required String eventName, Map<String, Object>? parameters}) async {
    try {
